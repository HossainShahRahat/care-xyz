...
export const metadata = {
  ...
  description:
    "Providing reliable care services for children, elderly, and family members. Secure and accessible caregiving for everyone.",
};
...
export default function Home() {
  ...
  const reviews = [
    ...
    },
    {
      name: "Rahim Khan",
      role: "Son of Patient",
      text: "The elderly care service for my father was exceptional.",
      star: 5,
    },
    {
      name: "Dr. Farhana",
      role: "Client",
      text: "Verified and timely service. The platform is very easy to use.",
      star: 4,
    },
  ];
      ...
      <section className="relative h-[600px] flex items-center justify-center text-center px-4">
        ...
        <div className="relative z-10 max-w-3xl mx-auto space-y-6">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300">
            Connecting families with trusted caregivers for babysitting, elderly
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">
                At Care.xyz, we believe everyone deserves reliable care. We make
                caregiving easy, secure, and accessible for everyone. [cite: 4]
              </p>
              <div className="grid grid-cols-2 gap-6 pt-4">
                <div className="p-4 bg-gray-50 dark:bg-white/5 rounded-xl">
                  <h3 className="text-2xl font-bold text-purple-600">500+</h3>
                  <p className="text-sm">Verified Carers</p>
                </div>
                <div className="p-4 bg-gray-50 dark:bg-white/5 rounded-xl">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((s) => (
              <div
                key={s.id}
                className="bg-white dark:bg-[#020410] rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all"
              >
            ...
            {reviews.map((r, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-600">{r.role}</p>
                </div>
              </div>
            ))}
          </div>
